...
def make_grids(scenario, ego_id, startframe, grid_length, max_disp_front=55, max_disp_rear=30, max_radius=55):
    ...
    nodes, edges = span_tree(ego_posG, initial_nodes, scenario.lanelet_network, max_disp_front, max_disp_rear, max_radius)
    ...
    return new_nodes, new_nodes_idx, new_edges, clusters, grids
...
def span_tree(ego_posG, nodes, lanelet_network, max_disp_front, max_disp_rear, max_radius):
    visited_nodes = set()
    out_nodes = []
    out_edges = []
    base_l = 4
